...
export function StatsGrid({ stats }: StatsGridProps) {
  ...
  },
  {
    ...
    icon: PhoneCall,
    color: "text-teal-500",
    percentage: stats.callConnectRate,
    showProgress: true,
  },
  {
    title: "Voicemail rate",
    value: stats.voicemailsLeft,
    icon: Voicemail,
    color: "text-yellow-500",
    percentage: stats.voicemailRate,
    showProgress: true,
  },
  {
    ...
    icon: CalendarCheck,
    color: "text-lime-500",
    percentage: stats.appointmentsSetRate,
    showProgress: true,
  },
    // {
    //   title: "Unsubscribed",
