...
/**
 * GET handler for /api/vapi/phone-numbers
 * Fetches available phone numbers from the Vapi API
 */
export async function GET() {
  try {
    ...
    if (!response.ok) {
      ...
      console.error("Error fetching Vapi phone numbers:", errorData);
    ...
    // Parse and return the phone numbers data
    ...
    console.error("Error in Vapi phone numbers API route:", error);
    return NextResponse.json(
