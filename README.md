...
- [Setting Up Email Reply Notifications](#setting-up-email-reply-notifications-optional)
  - [Create a Google Cloud Service Account](#1-create-a-google-cloud-service-account)
  - [Configure PubSub Topic and Subscription](#2-configure-pubsub-topic-and-subscription)
  - [Set Up Tunneling with ngrok](#3-set-up-tunneling-with-ngrok)
  - [Configure Gmail API to Use Your PubSub Topic](#4-configure-gmail-api-to-use-your-pubsub-topic)
  - [Update Environment Variables](#5-update-environment-variables)
  - [Restart Your Development Server](#6-restart-your-development-server)
...
🤖 **AI Features** <code><span style="background-color: #E3F2FD; color: #1976D2; padding: 0.2em 0.4em; border-radius: 3px; font-size: 0.85em; font-weight: 600;">COMING SOON</span></code> – Leverage artificial intelligence to enhance email personalization and optimize send times.
